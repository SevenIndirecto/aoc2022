# On Rust adventures for AOC 2022

Solved the first 3 days in rust, but got annoyed by the language. 
Although to be fair, it's mostly due to a lack of energy and the wondrous year 2022 :)

Decided I actually want a refresher on golang instead, so that's day 04 and onwards.

BELOW: Readme of Rust template copied from fspoettel.
